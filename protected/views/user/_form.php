...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'total_miles'); ?>
		<?php echo $form->textField($model,'total_miles'); ?>
		<?php echo $form->error($model,'total_miles'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'current_miles'); ?>
		<?php echo $form->textField($model,'current_miles'); ?>
		<?php echo $form->error($model,'current_miles'); ?>
	</div>
